...
Electronics has the highest number of transactions with 4 transactions.
Clothing and Furniture each have 3 transactions.
The dataset contains four regions: North, South, East and West.
East has the highest average transaction amount at 375.0.
West has the lowest average transaction amount at 190.0.
NumPy operations were used to calculate temperature statistics efficiently.
Pandas provided convenient methods for filtering, grouping, summarizing and manipulating tabular data.
🚀 Learning Outcomes
